...
const MGame3 = () => {
    return (
          <conteiner_1>
            <div className="name_box">	<p className="name_text"> War thunder </p>	</div>
            <text_box>
              <div className="conteiner_2"> <img src={WT}></img> </div>
              <div className="conteiner_3"> <p className="font_1"> Cool game about realistic tank and airplanes battle!</p> </div>
            </text_box>
